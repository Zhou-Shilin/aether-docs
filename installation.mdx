...
description: "Download and install Aether on your Android 13+ device. Learn about build flavors, required permissions, and optional integrations."
---
...
| Requirement | Detail |
|---|---|
| **Android version** | Android 13 or higher (minSdk 26) |
