...
#### `ui.pageButton(pageId, opts?)`

A navigation button that opens the registered page with the given `id` when tapped.

```typescript
ui.pageButton("dashboard") // navigates to the page registered with id "dashboard"
```
