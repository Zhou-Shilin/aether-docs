---
title: "Combined Pi and Aether Extension Example: Walkthrough"
sidebarTitle: "Combined Extension"
description: "A complete walkthrough of the aether-extension example — one package combining Pi agent commands with Aether UI surfaces, pages, storage, and event hooks."
---
...
3. Go to **Settings → Extensions** and tap **Import extension**.
