...
sidebarTitle: "Pages"
description: "Use registerPage to add extension-owned full-screen destinations that appear automatically in Aether's conversation drawer."
---
...
<ParamField path="icon" type="string">
  Icon name displayed next to the title in the drawer. Aether uses the [Lucide](https://lucide.dev/icons/) icon set. Defaults to `"extension"` when omitted.
</ParamField>
