...
description: "Use aether.host.invoke() to call Android host methods for app control, draft management, session navigation, model switching, and Alpine or Termux runtime execution."
---
