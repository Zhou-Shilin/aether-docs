...
- **Import a zip**: open Settings → Extensions, tap **Import extension**, and select the zip file. Aether extracts the package into `~/.aether/extensions` and loads it immediately.
