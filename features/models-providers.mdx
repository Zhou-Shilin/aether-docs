...
Aether supports a wide range of LLM providers via the [Pi framework](https://github.com/Shilin-LU/Pi) that powers it under the hood. You bring your own API keys — nothing is proxied through Aether's servers. Your keys go directly from your device to each provider's API endpoint.
