...
**Aether** is a general-purpose AI Agent for Android built on the [Pi framework](https://github.com/Zhou-Shilin/Aether). It pairs a minimalist, carefully polished UI with a powerful agentic execution engine that supports multiple LLM providers out of the box. Whether you want a capable AI chat companion or a fully autonomous on-device agent that can run shell commands and control your phone, Aether handles both.
...
<CardGroup cols={2}>
  ...
  <Card title="Built-in Alpine Linux VM" icon="terminal">
  ...
  <Card title="Termux & Shizuku" icon="mobile">
