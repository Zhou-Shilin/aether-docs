...
<CardGroup cols={2}>
  ...
  <Card title="Built-in Alpine Linux VM" icon="terminal" href="/features/alpine-runtime">
    A managed Alpine Linux environment is initialized from assets bundled with Aether. Aether calls shell commands and CLI tools directly through this environment, giving the agent real compute power on your device.
  </Card>
  <Card title="Termux & Shizuku" icon="mobile" href="/features/termux-shizuku">
    Optionally integrate with Termux for direct Android shell access or use Shizuku to authorize Agent Mode's isolated virtual display without root.
  </Card>
